  ...
  view:function(){
    ...
    return m("div",null,
      ...
      m("div",{className:"ExtensionPage-settings"},m("div",{style:"max-width:600px;margin:0 auto;"},
        ...
        m(IntegrationToggle,{settingKey:"ernestdefoe-digest-mail.enable_picks",      extData:exts.picks||{},      description:"Show upcoming CFB games, recent results, and the picks leaderboard. Supports confidence mode and week/season/all-time leaderboard scopes.", installedNote:"resofire/picks is installed and active",          notInstalledNote:"resofire/picks is not installed or is disabled"}),
